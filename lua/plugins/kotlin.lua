...
return {
	{
		...
		keys = {
			{ "<leader>gdb", gradlew_cmd("build"), desc = "[G]ra[d]le [b]uild" },
			{ "<leader>gdt", gradlew_cmd("test"), desc = "[G]ra[d]le [t]est" },
			{ "<leader>gdc", gradlew_cmd("clean"), desc = "[G]ra[d]le [c]lean" },
			{ "<leader>gdr", gradlew_cmd("run"), desc = "[G]ra[d]le [r]un" },
			{ "<leader>gdR", gradlew_cmd("runClient"), desc = "[G]ra[d]le [R]un client" },
			{ "<leader>gdC", gradlew_cmd("clean build"), desc = "[G]ra[d]le [C]lean build" },
		},
	},
}
